...
input_json_path = "./dental_json/classification/Gingivitis/Gingivitis_qa.json"
output_json_path = "./dental_json/classification/Gingivitis/Gingivitis_qa_dialogue.jsonl"
