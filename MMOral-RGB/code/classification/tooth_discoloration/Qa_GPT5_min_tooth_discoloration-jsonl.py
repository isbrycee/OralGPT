...
input_json_path = "./dental_json/classification/tooth_discoloration/tooth_discoloration_qa.json"
output_json_path = "./dental_json/classification/tooth_discoloration/tooth_discoloration_qa_dialogue.jsonl"
