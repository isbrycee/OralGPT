...
input_json_path = "./dental_json/classification/defect_of_dentition/defect_of_dentition_qa.json"
output_json_path = "./dental_json/classification/defect_of_dentition/defect_of_dentition_qa_dialogue.jsonl"
